...
<%--          enctype="multipart/form-data"      --%>
                <input type="text" name="id" hidden="hidden" value="${contractProduct.id}">
                <input type="text" name="contractId" hidden="hidden" value="${contractProduct.contractId}">
                <input type="text"  name="factoryName" hidden="hidden" id="factoryName" value="${contractProduct.factoryName}">
