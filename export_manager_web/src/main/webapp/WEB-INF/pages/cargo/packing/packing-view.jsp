...
<head>
    ...
    <title>AdminLTE2-PackingList</title>
...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <!-- 内容头部 /-->
    <form id="editForm" class="form" action="${ctx}/cargo/packingList/edit.do" method="post">
    <!-- 正文区域 -->
    <section class="content">

        <!--订单信息-->
        <div class="panel panel-default">
            <div class="panel-heading">Packing Order</div>
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-2 title">Contract Number</div>
                    <div class="col-md-4 data" style="line-height:34px">
        ...
        <div class="box-tools text-center">
            ...
            <button type="button" class="btn bg-maroon" onclick="history.back(-1);">Back</button>
        </div>
