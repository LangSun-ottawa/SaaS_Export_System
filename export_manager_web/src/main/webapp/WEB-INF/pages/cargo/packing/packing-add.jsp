        ...
        <div class="panel panel-default">
            <div class="panel-heading">新增装箱单</div>
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" disabled="disabled" class="form-control" placeholder="发票号" name="invoiceNo" value="${packing.invoiceNo}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="发票日期"  name="invoiceDate" class="form-control pull-right"
                                   value="<fmt:formatDate value="${packing.invoiceDate}" pattern="yyyy-MM-dd"/>" id="signingDate">
                        </div>
                    </div>
