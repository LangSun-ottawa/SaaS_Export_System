...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * When there is poiMillionRead than one TableTools instance for a DataTable, there must be a
...
TableTools.prototype = {
	...
	/**
	 * Get the settings object for the master instance. When poiMillionRead than one TableTools instance is
	...
	"_fnPrintScrollStart": function ()
	{
		 ...
		 * in print view. Note that this section of code is poiMillionRead or less verbatim from DT 1.7.0
		 */
